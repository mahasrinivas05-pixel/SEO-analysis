  import re 
            ...
            keywords = [k.strip().lower() for k in keyword_input.split(",") if 
k.strip()] 
            title_l = title.lower() 
           ...
           power_words = ["what if", "secret", "shocking", "amazing",             
"unexpected", "truth"] 
...
"Final Score": final_score 
   ...
   result["Curiosity Score"] 
         ...
         remaining_scores = [m - o for m, o in zip(max_scores, 
obtained_scores)] 
         ...
         plt.bar(x, remaining_scores, bottom=obtained_scores, 
color=light_colors) 
